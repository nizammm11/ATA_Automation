...
for (def row = 1; row <= 6; row++) {
    ...
    WebUI.setText(findTestObject('Object Repository/ATAU/location page/location'), findTestData('ATAUcarRos').getValue('Location', 
            row))
    ...
    if (findTestData('ATAUcarRos').getValue('ServiceVehicle', row) == 'Car') {
    ...
    if (findTestData('ATAUcarRos').getValue('ServiceType', row) == 'Accident') {
        WebUI.click(findTestObject('ATAU/Car service list/btn_accident'))
    } else if (findTestData('ATAUcarRos').getValue('ServiceType', row) == 'Cannot start') {
        WebUI.click(findTestObject('ATAU/Car service list/btn_cannot start'))
    } else if (findTestData('ATAUcarRos').getValue('ServiceType', row) == 'Flat tyre') {
        WebUI.click(findTestObject('ATAU/Car service list/btn_flat tyre'))
    } else if (findTestData('ATAUcarRos').getValue('ServiceType', row) == 'Petrol') {
        WebUI.click(findTestObject('ATAU/Car service list/btn_petrol'))
    } else if (findTestData('ATAUcarRos').getValue('ServiceType', row) == 'Locked') {
        WebUI.click(findTestObject('ATAU/Car service list/btn_locked'))
    } else {
        WebUI.click(findTestObject('ATAU/Car service list/btn_Im not sure whats wrong'))
    }
    ...
    WebUI.setText(findTestObject('ATAU/details page/input_Vehicle Registration Number'), findTestData('ATAUcarRos').getValue(
            'VehicleNumber', row))

    WebUI.setText(findTestObject('ATAU/details page/input_Mobile Number'), findTestData('ATAUcarRos').getValue('PhoneNumber', 
            row))

    WebUI.setText(findTestObject('ATAU/details page/input_Name'), findTestData('ATAUcarRos').getValue('Nama', row))
