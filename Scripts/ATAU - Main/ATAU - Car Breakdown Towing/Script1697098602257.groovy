...
for (def row = 1; row <= 3; row++) {
    ...
    WebUI.setText(findTestObject('Object Repository/ATAU/location page/location'), findTestData('ATAUcarBT').getValue('Location', 
            row))
    ...
    if (findTestData('ATAUcarBT').getValue('ServiceVehicle', row) == 'Car') {
        WebUI.click(findTestObject('ATAU/main page/btn_Car'))
    } else {
        WebUI.click(findTestObject('ATAU/main page/btn_Motorcycle'))
    }
    
    /*__________________Car Service Type___________________________________*/
    if (findTestData('ATAUcarBT').getValue('ServiceType', row) == 'Brake') {
        WebUI.click(findTestObject('ATAU/Car service list/btn_brake'))
    } else if (findTestData('ATAUcarBT').getValue('ServiceType', row) == 'Smoke') {
    ...
    WebUI.setText(findTestObject('ATAU/details page/input_Vehicle Registration Number'), findTestData('ATAUcarBT').getValue(
            'VehicleNumber', row))

    WebUI.setText(findTestObject('ATAU/details page/input_Mobile Number'), findTestData('ATAUcarBT').getValue('PhoneNumber', 
            row))

    WebUI.setText(findTestObject('ATAU/details page/input_Name'), findTestData('ATAUcarBT').getValue('Nama', row))

    WebUI.click(findTestObject('ATAU/details page/tick_TC'))

    //__________________CAPTCHA________________________________________
    WebUI.delay(20)
