...
for (def row = 1; row <= 4; row++) {
    ...
    WebUI.verifyElementText(findTestObject('Object Repository/ATAU/button_Got It'), 'Got It', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    WebUI.setText(findTestObject('Object Repository/ATAU/location page/location'), findTestData('ATAUmotorBT').getValue(
            'Location', row))
    ...
    if (findTestData('ATAUmotorBT').getValue('ServiceVehicle', row) == 'Car') {
    ...
    if (findTestData('ATAUmotorBT').getValue('ServiceType', row) == 'Flat tyre') {
        WebUI.click(findTestObject('ATAU/Motor service list/btn_motor_tyre'))
    } else if (findTestData('ATAUmotorBT').getValue('ServiceType', row) == 'Cannot start') {
        WebUI.click(findTestObject('ATAU/Motor service list/btn_motor_cannot_start'))
    } else if (findTestData('ATAUmotorBT').getValue('ServiceType', row) == 'Brake') {
        WebUI.click(findTestObject('ATAU/Motor service list/btn_motor_brake'))
    } else {
        WebUI.click(findTestObject('ATAU/Motor service list/btn_motor_gear'))
    }
    ...
    if (findTestData('ATAUmotorBT').getValue('TowingDestination', row) == 'Preferred destination') {
        WebUI.click(findTestObject('ATAU/preferred destination/preferred_Destination'))
    } else {
    ...
    WebUI.setText(findTestObject('ATAU/preferred destination/input_destination'), findTestData('ATAUmotorBT').getValue('Destination', 
            row))
    ...
    WebUI.setText(findTestObject('ATAU/details page/input_Vehicle Registration Number'), findTestData('ATAUmotorBT').getValue(
            'VehicleNumber', row))

    WebUI.setText(findTestObject('ATAU/details page/input_Mobile Number'), findTestData('ATAUmotorBT').getValue('PhoneNumber', 
            row))

    WebUI.setText(findTestObject('ATAU/details page/input_Name'), findTestData('ATAUmotorBT').getValue('Nama', row))
