...
WebUI.setText(findTestObject('ATA_Partner/Vehicle/Vehicle/fill_vehicleNumber'), 'WRT898')
...
WebUI.click(findTestObject('ATA_Partner/Vehicle/Vehicle/Truck/Weight/7000 kg'))
