...
WebUI.setText(findTestObject('ATA_Partner/Vehicle/Vehicle/fill_vehicleNumber'), 'WZY2345')
...
WebUI.click(findTestObject('ATA_Partner/Vehicle/Vehicle/Truck/Weight/4500 kg'))
