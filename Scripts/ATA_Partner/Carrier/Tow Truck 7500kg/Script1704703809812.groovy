...
WebUI.setText(findTestObject('ATA_Partner/Vehicle/Vehicle/fill_vehicleNumber'), 'WRT8990')
...
WebUI.click(findTestObject('ATA_Partner/Vehicle/Vehicle/Truck/Weight/7500 kg'))
