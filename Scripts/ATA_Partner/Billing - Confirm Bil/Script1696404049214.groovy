...
WebUI.click(findTestObject('ATA_Partner/Billing/checkbox_bil'))

WebUI.click(findTestObject('ATA_Partner/Billing/bil_checkbox'))

WebUI.click(findTestObject('ATA_Partner/Billing/button_Confirm'))

WebUI.click(findTestObject('ATA_Partner/Billing/button_Yes, proceed'))
