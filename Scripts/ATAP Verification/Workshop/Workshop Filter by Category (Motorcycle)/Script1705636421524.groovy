...
WebUI.verifyElementPresent(findTestObject('ATAP EH/Workshop/filterWorkshop/Category_dropdown'), 0)

WebUI.click(findTestObject('ATAP EH/Workshop/filterWorkshop/Category_dropdown'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2)

WebUI.click(findTestObject('ATAP EH/Workshop/filterWorkshop/Page_Dashboard/li_Motorcycle'), FailureHandling.STOP_ON_FAILURE)
