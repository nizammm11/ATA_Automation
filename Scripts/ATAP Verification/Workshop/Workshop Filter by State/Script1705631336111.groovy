...
WebUI.verifyElementPresent(findTestObject('ATAP EH/Workshop/filterWorkshop/textfield_searchByState'), 0)

WebUI.setText(findTestObject('ATAP EH/Workshop/filterWorkshop/textfield_searchByState'), findTestData('ATAP New Case').getValue(
        'State', row))
