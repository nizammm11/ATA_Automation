...
WebUI.takeScreenshot(('D:\\AutomationATA\\ATA_Screenshot\\//ATAP//Verification//TC46-Automation Case_' + dateTime) + '.png')

WebUI.click(findTestObject('ATAP HH/General/Case Select Vehicle No'))

WebUI.takeFullPageScreenshot(('D:\\AutomationATA\\ATA_Screenshot\\//ATAP//Verification//TC46-Automation Case Details_' + dateTime) + '.png')
...
WebUI.takeScreenshot(('D:\\AutomationATA\\ATA_Screenshot\\//ATAP//Verification//TC47-Automation & Breakdown Towing Case_' + dateTime) + 
    '.png')

WebUI.click(findTestObject('ATAP HH/General/Case Select Vehicle No'))

WebUI.takeFullPageScreenshot(('D:\\AutomationATA\\ATA_Screenshot\\//ATAP//Verification//TC47-Automation & Breakdown Towing Case Details_' + 
    dateTime) + '.png')
