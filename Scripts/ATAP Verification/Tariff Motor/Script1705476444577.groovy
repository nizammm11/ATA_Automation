...
WebUI.verifyElementText(findTestObject('ATAP EH/Tariff/Page_Dashboard/distance_Breakdown  Accident Towing Charges (Private motorcycle)'), 
    'Breakdown / Accident Towing Charges (Private motorcycle)')

WebUI.verifyElementText(findTestObject('ATAP EH/Tariff/Page_Dashboard/title_Addons'), 'Addons')

WebUI.verifyElementText(findTestObject('ATAP EH/Tariff/Page_Dashboard/addons_Breakdown  Accident Towing Charges (Private motorcycle)'), 
    'Breakdown / Accident Towing Charges (Private motorcycle)')
